...
chat_requirements_timeout = int(os.getenv('CHAT_REQUIREMENTS_TIMEOUT', 20))
chat_conversation_timeout = int(os.getenv('CHAT_CONVERSATION_TIMEOUT', 30))
...
logger.info("CHAT_CONVERSATION_TIMEOUT: " + str(chat_conversation_timeout))
